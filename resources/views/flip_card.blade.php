                                            ...
                                            <div class="panel-body text-center">
                                                <div class="hover-content">
                                                    <div class="visible-part">
                                                      <div id="owl-portfolio1">
                                                        <div class="item"><img src="http://placehold.it/770x450" alt="Owl Image"></div>
                                                        <div class="item"><img src="http://placehold.it/770x450" alt="Owl Image"></div>
                                                      </div>
                                                    </div>
                                                    <div class="hidden-part">
                                                        <h4 class="type">Venue Name</h4>
                                                        <h4 padding-top: "25px" padding-right: "50px" padding-bottom: "25px" padding-left: "50px">Something something </h4>
                                                        <a href="#">
                                                            <h5 class="text-primary details">lastly</h5>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
